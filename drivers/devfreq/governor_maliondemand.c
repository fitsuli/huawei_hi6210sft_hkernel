...
#define DFMO_MAX_ANIMATION_BOOST_FREQ	(400000000)
#define DFMO_MIN_HISPEED_FREQ		(250000000)
#define DFMO_MAX_HISPEED_FREQ		(500000000)
#define DFMO_DEFAULT_HISPEED_FREQ	(400000000)
#endif
...
#define DFMO_MIN_ANIMATION_BOOST_FREQ	(250000000)
#define DFMO_DEFAULT_ANIMATION_BOOST_FREQ	(400000000)
